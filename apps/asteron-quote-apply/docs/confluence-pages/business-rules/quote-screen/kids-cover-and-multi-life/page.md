...
| `KID-12` | Date of birth is a genuine native date input with hard min/max bounds observed at roughly a 21-year rolling window ending "today" — re-derive the exact bound relative to the current date rather than treating it as a fixed calendar date. |
